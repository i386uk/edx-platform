...
class TestGetTranscript(SharedModuleStoreTestCase):
    ...
    def create_transcript(self, subs_id, language=u'en', filename='video.srt', html5_sources=[]):
        """
        create transcript.
        """
        transcripts = {}
        ...
        possible_subs = [subs_id] + transcripts_utils.get_html5_ids(html5_sources)
    ...
    @ddt.unpack
    def test_get_transcript_from_contentstore(self, language, subs_id, expected_filename):
        """
        ...
        self.create_transcript(subs_id, language, base_filename, html5_sources)
